...
**行きたい場所・やりたいこと**
- ［美術・歴史系］コロッセオ＆フォロ・ロマーノ（事前予約で並ばず）／バチカン美術館＆システィーナ礼拝堂／ボルゲーゼ美術館／ウフィツィ／アカデミア（ダヴィデ像）
- ［街・カフェ・体験系］トレヴィの泉／ドゥオモのクーポラに登る／ミケランジェロ広場の夕景／トラステヴェレの夜カフェ／ローマ→フィレンツェは高速鉄道で

**気になるホテル・宿の条件**
- 条件：旧市街・中心部の立地／1泊2.5万円まで／雰囲気のある内装・朝食付き
- ローマ候補：Hotel Locarno ／ The Inn at the Spanish Steps
- フィレンツェ候補：Hotel Davanzati ／ Hotel Spadai

**食べたいもの**
- カルボナーラ／カチョ・エ・ペペ ・ ジェラート食べ比べ ・ ビステッカ ・ 朝のコルネット

**備考（こだわり・制約）**
- 主要スポットは行列が嫌なので事前予約前提／早朝発は避けたい（出発は9時以降）
- 午後はカフェや街歩きでゆっくり／都市間は鉄道で一方向（戻らない）
- 宿はそれぞれの特徴を教えてほしい・他にいい宿があれば理由つきで
